...
[nrnfile,nrnpath] = uigetfile('*.txt', 'Select the neuron coordinates file');
...
% Plot
fig = figure('units','normalized','outerposition',[0 0 1 1]);
h = plot3([Xc Xp]',[Yc Yp]',[Zc Zp]','k','LineWidth',1.25);
...
% [file,path] = uiputfile('.txt','Output location');
respath = uigetdir('','Output directory');
