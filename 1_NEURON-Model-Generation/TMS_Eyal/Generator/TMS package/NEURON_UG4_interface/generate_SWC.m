%% Import data
index = importdata(['..' filesep 'results' filesep 'locs' filesep 'index.dat']);
locs = importdata(['..' filesep 'results' filesep 'locs' filesep 'locs_all_seg.txt']);
diams = index.data(:,1);
...
%% Export SWC file
writematrix(swc_3p,'neuron_out.swc','FileType','text','Delimiter','space');